          ...
          <div class="px-4 py-3 bg-gray-50 border-t border-gray-100">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-6">
                <!-- 点赞按钮 -->
                <button @click="handleLike(story.storyId)"
                        class="flex items-center gap-2 text-gray-600 hover:text-blue-500 transition-colors duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                       :class="{'text-red-500': story.isLike}"
                       viewBox="0 0 24 24" :fill="story.isLike===true?'#FF5555':'none'" stroke="currentColor">
                ...
                <!-- 收藏按钮 -->
                <button @click="handleFavourite(story.storyId)"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                       ...
                       viewBox="0 0 24 24"  :fill="story.isFavourite===true?'#ead86a':'none'" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
